        ...
        json.serialize(
          new V1HorizontalPodAutoscaler()
            ...
            .spec(new V1HorizontalPodAutoscalerSpec()
              .scaleTargetRef(new V1CrossVersionObjectReference().apiVersion("apps/v1").kind(kind).name(name)))
    ...
    String deployment =
        json.serialize(
          ...
          .spec(new V1DeploymentSpec()
            .replicas(3)
            .selector(new V1LabelSelector().matchLabels(ImmutableMap.of("app", "my-app")))
            .template(new V1PodTemplateSpec()
              .metadata(new V1ObjectMeta().labels(ImmutableMap.of("app", "my-app")))
              .spec(new V1PodSpec().containers(containers.stream().toList()).initContainers(initContainers.stream().toList()))))
                  ...
                  .spec(new V1PodSpec()
                    .addContainersItem(new V1Container()
                      .addEnvItem(new V1EnvVar()
                        .valueFrom(new V1EnvVarSource().configMapKeyRef(new V1ConfigMapKeySelector().name(configMapRef))))))))
