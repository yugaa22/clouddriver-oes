            ...
            new V1ReplicaSet()
              .spec(new V1ReplicaSetSpec()
                .template(new V1PodTemplateSpec()
                  .spec(new V1PodSpec()
                    .addContainersItem(new V1Container().name("my-image-with-tag").image("gcr.io/my-repository/my-image:my-tag"))
                    .addContainersItem(new V1Container().name("my-image-without-tag").image("gcr.io/my-other-repository/some-image")))))
              ...
              .template(new V1PodTemplateSpec()
                .spec(new V1PodSpec()
                  .addVolumesItem(new V1Volume()
                    .configMap(new V1ConfigMapVolumeSource().name("first-config-map")))
                  .addVolumesItem(new V1Volume()
                    .configMap(new V1ConfigMapVolumeSource().name("second-config-map")))
                  .addVolumesItem(new V1Volume()
                    .secret(new V1SecretVolumeSource().secretName("first-secret")))
                  .addVolumesItem(new V1Volume().secret(new V1SecretVolumeSource().secretName("second-secret"))))))
//            new V1ReplicaSetBuilder()
//                .withNewSpec()
//                .withNewTemplate()
//                .withNewSpec()
                  ...
                  .addVolumesItem(new V1Volume()
                    ...
                    .projected(new V1ProjectedVolumeSource()
                      .addSourcesItem(new V1VolumeProjection()
                        .configMap(new V1ConfigMapProjection().name("first-config-map")))
                      .addSourcesItem(new V1VolumeProjection()
                        .configMap(new V1ConfigMapProjection().name("second-config-map")))
                      .addSourcesItem(new V1VolumeProjection()
                        .secret(new V1SecretProjection().name("first-secret")))
                      .addSourcesItem(new V1VolumeProjection()
                        .secret(new V1SecretProjection().name("second-secret"))))))))
//            new V1ReplicaSetBuilder()
//                .withNewSpec()
//                .withNewTemplate()
//                .withNewSpec()
            ...
            .spec(new V1ReplicaSetSpec()
              .template(new V1PodTemplateSpec()
                .spec(new V1PodSpec()
                  .addContainersItem(new V1Container()
                    .name("my-image-with-tag")
                    .addEnvFromItem(new V1EnvFromSource()
            ...
            new V1HorizontalPodAutoscaler()
              .spec(new V1HorizontalPodAutoscalerSpec()
                .scaleTargetRef(new V1CrossVersionObjectReference()
                  .name("my-deployment").kind("deployment")))
              ...
              .jobTemplate(new V1JobTemplateSpec()
                .spec(new V1JobSpec()
                  .template(new V1PodTemplateSpec()
                    .spec(new V1PodSpec()
                      .addContainersItem(new V1Container()
                        .image("gcr.io/my-repository/my-image:original-tag")
                        .name("my-image-with-tag")))))))
//            new V1beta1CronJobBuilder()
//                .withNewSpec()
//                .withNewJobTemplate()
